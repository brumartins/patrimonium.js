import { EnvironmentOptions, Rental, Property, Loan, SimpleDate, Employment } from ".";

/**
 * Represents the initial situation of a `Person`.
 */
export interface PersonInitialSituation {
